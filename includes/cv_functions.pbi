...
ImportC "opencv_world300.lib"
  ...
  cvCanny(*image, *edges, threshold1.d, threshold2.d, aperture_size, L2gradient.b)
  ...
  cvKMeans2(*samples, cluster_count, *labels, type, max_iter, epsilon.d, attempts, rng.f, flags, *centers, compactness.d)
  ...
  cvPolyLine(*img, Array pts.CvPoint(1), npts, contours, is_closed.b, blue.d, green.d, red.d, alpha.d, thickness, line_type, shift)
  ...
  cvSaveImage(filenames.p-ascii, *image, *params)
...
ProcedureC cvAbs(*src, *dst)
  cvAbsDiffS(*src, *dst, 0, 0, 0, 0)
EndProcedure

ProcedureC cvCalcBackProject(Array *image.IplImage(1), *dst, *hist)
  cvCalcArrBackProject(@*image(), *dst, *hist)
EndProcedure

ProcedureC cvCalcHist(Array *image.IplImage(1), *hist, accumulate, *mask)
  cvCalcArrHist(@*image(), *hist, accumulate, *mask)
EndProcedure

ProcedureC.d cvContourPerimeter(*contour)
  ProcedureReturn cvArcLength(*contour, start_index, end_index, 1)
EndProcedure

ProcedureC cvConvert(*src, *dst)
  cvConvertScale(*src, *dst, 1, 0)
EndProcedure

ProcedureC cvEllipseBox(*img, x.f, y.f, width.f, height.f, angle.f, blue.d, green.d, red.d, alpha.d, thickness, line_type, shift)
  axes.CvSize
...
ProcedureC cvGetCol(*arr, *submat, col)
  ProcedureReturn cvGetCols(*arr, *submat, col, col + 1)
EndProcedure

ProcedureC.d cvGetHistValue_1D(*hist.CvHistogram, idx0)
  ProcedureReturn cvPtr1D(*hist\bins, idx0, #Null)
EndProcedure

ProcedureC.d cvGetHistValue_2D(*hist.CvHistogram, idx0, idx1)
  ProcedureReturn cvPtr2D(*hist\bins, idx0, idx1, #Null)
EndProcedure

ProcedureC.d cvGetHistValue_3D(*hist.CvHistogram, idx0, idx1, idx2)
  ProcedureReturn cvPtr3D(*hist\bins, idx0, idx1, idx2, #Null)
EndProcedure

ProcedureC.d cvGetHistValue_nD(*hist.CvHistogram, *idx)
  ProcedureReturn cvPtrND(*hist\bins, *idx, 0, 1, #Null)
EndProcedure

ProcedureC cvGetRow(*arr, *submat, row)
  ProcedureReturn cvGetRows(*arr, *submat, row, row + 1, 1)
EndProcedure

ProcedureC cvMatMulAdd(*src1, *src2, *src3, *dst)
  cvGEMM(*src1, *src2, 1, *src3, 1, *dst, 0)
EndProcedure

ProcedureC cvMatMul(*src1, *src2, *dst)
  cvMatMulAdd(*src1, *src2, #Null, *dst)
EndProcedure

ProcedureC.d cvQueryHistValue_1D(*hist.CvHistogram, idx0)
  ProcedureReturn cvGetReal1D(*hist\bins, idx0)
EndProcedure

ProcedureC.d cvQueryHistValue_2D(*hist.CvHistogram, idx0, idx1)
  ProcedureReturn cvGetReal2D(*hist\bins, idx0, idx1)
EndProcedure

ProcedureC.d cvQueryHistValue_3D(*hist.CvHistogram, idx0, idx1, idx2)
  ProcedureReturn cvGetReal3D(*hist\bins, idx0, idx1, idx2)
EndProcedure

ProcedureC.d cvQueryHistValue_nD(*hist.CvHistogram, *idx)
  ProcedureReturn cvGetRealND(*hist\bins, *idx)
EndProcedure

ProcedureC cvReadByName(*fs, *map, name.s, *attributes)
  ProcedureReturn cvRead(*fs, cvGetFileNodeByName(*fs, *map, name), *attributes)
EndProcedure

ProcedureC cvReadInt(*node.CvFileNode, default_value)
  If Not *node
...
ProcedureC cvReadIntByName(*fs, *map, name.s, default_value)
  ProcedureReturn cvReadInt(cvGetFileNodeByName(*fs, *map, name), default_value)
EndProcedure

ProcedureC.d cvReadReal(*node.CvFileNode, default_value.d)
  Define Result.d
...
ProcedureC.d cvReadRealByName(*fs, *map, name.s, default_value.d)
  ProcedureReturn cvReadReal(cvGetFileNodeByName(*fs, *map, name), default_value)
EndProcedure

ProcedureC.c cvReadString(*node.CvFileNode, *default_value)
  Define Result.c
...
ProcedureC.c cvReadStringByName(*fs, *map, name.s, default_value.c)
  ProcedureReturn cvReadString(cvGetFileNodeByName(*fs, *map, name), default_value)
EndProcedure

ProcedureC cvSubS(*src, val0.d, val1.d, val2.d, val3.d, *dst, *mask)
  cvAddS(*src, -val0, -val1, -val2, -val3, *dst, *mask)
EndProcedure

opencv_ffmpeg300 = OpenLibrary(#PB_Any, "opencv_ffmpeg300.dll")
...
If opencv_ffmpeg300
  ...
  create_InputMediaStream_FFMPEG = GetFunction(opencv_ffmpeg300, "create_InputMediaStream_FFMPEG")
  create_OutputMediaStream_FFMPEG = GetFunction(opencv_ffmpeg300, "create_OutputMediaStream_FFMPEG")
  cvCreateFileCapture_FFMPEG = GetFunction(opencv_ffmpeg300, "cvCreateFileCapture_FFMPEG")
  cvCreateVideoWriter_FFMPEG = GetFunction(opencv_ffmpeg300, "cvCreateVideoWriter_FFMPEG")
  cvGetCaptureProperty_FFMPEG = GetFunction(opencv_ffmpeg300, "cvGetCaptureProperty_FFMPEG")
  cvGrabFrame_FFMPEG = GetFunction(opencv_ffmpeg300, "cvGrabFrame_FFMPEG")
  cvReleaseCapture_FFMPEG = GetFunction(opencv_ffmpeg300, "cvReleaseCapture_FFMPEG")
  cvReleaseVideoWriter_FFMPEG = GetFunction(opencv_ffmpeg300, "cvReleaseVideoWriter_FFMPEG")
  cvRetrieveFrame_FFMPEG = GetFunction(opencv_ffmpeg300, "cvRetrieveFrame_FFMPEG")
  cvSetCaptureProperty_FFMPEG = GetFunction(opencv_ffmpeg300, "cvSetCaptureProperty_FFMPEG")
  cvWriteFrame_FFMPEG = GetFunction(opencv_ffmpeg300, "cvWriteFrame_FFMPEG")
  read_InputMediaStream_FFMPEG = GetFunction(opencv_ffmpeg300, "read_InputMediaStream_FFMPEG")
  release_InputMediaStream_FFMPEG = GetFunction(opencv_ffmpeg300, "release_InputMediaStream_FFMPEG")
  release_OutputMediaStream_FFMPEG = GetFunction(opencv_ffmpeg300, "release_OutputMediaStream_FFMPEG")
  write_OutputMediaStream_FFMPEG = GetFunction(opencv_ffmpeg300, "write_OutputMediaStream_FFMPEG")
EndIf
